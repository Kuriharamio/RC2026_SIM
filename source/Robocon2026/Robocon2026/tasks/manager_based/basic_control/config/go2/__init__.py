...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point": f"{__name__}.config.go2.flat_ppo_env_cfg:FlatEnvCfg",
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.config.go2.flat_ppo_env_cfg:FlatEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:FlatPPORunnerCfg",
    },
)
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.config.go2.rough_ppo_env_cfg:RoughEnvCfg",
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.config.go2.rough_ppo_env_cfg:RoughEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:RoughPPORunnerCfg",
    },
)
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.config.go2.rough_distillation_env_cfg:RoughDistillationEnvCfg",
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.config.go2.rough_distillation_env_cfg:RoughDistillationEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:RoughDistillationRunnerCfg",
    },
)
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.config.go2.rough_fintune_env_cfg:RoughFintuneEnvCfg",
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.config.go2.rough_fintune_env_cfg:RoughFinetuneEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:RoughStudentPPORunnerCfg",
    },
)
