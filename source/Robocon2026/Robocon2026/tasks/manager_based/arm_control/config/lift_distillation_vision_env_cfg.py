...
@configclass
class ArmControalLiftDistillationVisionEnvCfg(ArmControlEnvCfg):
    def __post_init__(self):
        ...
        self.scene.other_contact_forces.debug_vis = False
        self.scene.jaw_contact_forces.debug_vis = False
        self.scene.gripper_contact_forces.debug_vis = False
        # * rewards
...
@configclass
class ArmControalLiftDistillationVisionEnvCfg_PLAY(ArmControalLiftDistillationVisionEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
